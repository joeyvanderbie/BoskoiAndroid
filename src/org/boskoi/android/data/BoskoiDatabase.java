...
//  		}
  ...
  public Cursor fetchAllCategories(Locale locale){
...
//		return mDb.rawQuery(sql, new String[] { locale } );
		 String sql = "SELECT "+CATEGORIES_TABLE+"."+CATEGORY_COLOR+" AS "+CATEGORY_COLOR+" , "
			+CATEGORIES_TABLE+"."+CATEGORY_IS_UNREAD+" AS "+CATEGORY_IS_UNREAD+" , "
			+ CATEGORIES_TABLE+"."+CATEGORY_PARENT_ID+" AS "+CATEGORY_PARENT_ID+" , "
			+ CATEGORIES_TABLE+"."+CATEGORY_TITLE_LA+" AS "+CATEGORY_TITLE_LA+" , "
			+ CATEGORIES_TABLE+"."+CATEGORY_ID+" AS "+CATEGORY_ID+" , "
			+ CATEGORIES_TABLE+"."+CATEGORY_TITLE+" AS "+CATEGORY_TITLE+" , "
			+ CATEGORIES_TABLE+"."+CATEGORY_DESC+" AS "+CATEGORY_DESC+" , "
			+ CATEGORIES_TABLE+"."+CATEGORY_LOCALE+" AS "+CATEGORY_LOCALE+" "+
			" FROM "+CATEGORIES_TABLE+" LEFT JOIN "+CATEGORIES_LANG_TABLE
			+" ON ("+CATEGORIES_LANG_TABLE+"."+CATEGORY_ID+"="+CATEGORIES_TABLE+"."+CATEGORY_ID+" AND "+ CATEGORIES_LANG_TABLE+"."+CATEGORY_LOCALE+"= '"+locale.getLanguage()+"_"+locale.getCountry()+"') "
			+" WHERE "+CATEGORIES_TABLE+"."+CATEGORY_TITLE+" IS NOT NULL AND "+CATEGORIES_LANG_TABLE+"."+CATEGORY_TITLE+" IS NULL"
			
+" UNION " 
+"SELECT "+CATEGORIES_TABLE+"."+CATEGORY_COLOR+" AS "+CATEGORY_COLOR+" , "
			+CATEGORIES_TABLE+"."+CATEGORY_IS_UNREAD+" AS "+CATEGORY_IS_UNREAD+" , "
			+ CATEGORIES_TABLE+"."+CATEGORY_PARENT_ID+" AS "+CATEGORY_PARENT_ID+" , "
			+ CATEGORIES_TABLE+"."+CATEGORY_TITLE_LA+" AS "+CATEGORY_TITLE_LA+" , "
			+ CATEGORIES_TABLE+"."+CATEGORY_ID+" AS "+CATEGORY_ID+" , "
			+ CATEGORIES_LANG_TABLE+"."+CATEGORY_TITLE+" AS "+CATEGORY_TITLE+" , "
			+ CATEGORIES_LANG_TABLE+"."+CATEGORY_DESC+" AS "+CATEGORY_DESC+" , "
  ...
  public Cursor fetchCategoriesFromParent(int parentId, Locale locale) {
		 String sql = "SELECT "+CATEGORIES_TABLE+"."+CATEGORY_COLOR+" AS "+CATEGORY_COLOR+" , "
			...
			" FROM "+CATEGORIES_TABLE+" LEFT JOIN "+CATEGORIES_LANG_TABLE
			+" ON ("+CATEGORIES_LANG_TABLE+"."+CATEGORY_ID+"="+CATEGORIES_TABLE+"."+CATEGORY_ID+" AND "+ CATEGORIES_LANG_TABLE+"."+CATEGORY_LOCALE+"= '"+locale.getLanguage()+"_"+locale.getCountry()+"') "
			+" WHERE "+CATEGORIES_TABLE+"."+CATEGORY_PARENT_ID+" = "+parentId+" AND "+CATEGORIES_TABLE+"."+CATEGORY_TITLE+" IS NOT NULL AND "+CATEGORIES_LANG_TABLE+"."+CATEGORY_TITLE+" IS NULL"
...
//		  				+" WHERE "+CATEGORIES_LANG_TABLE+"."+CATEGORY_ID+" = ? AND "+ CATEGORIES_LANG_TABLE+"."+CATEGORY_LOCALE+"= ?  AND "+CATEGORIES_LANG_TABLE+"."+CATEGORY_ID+"="+CATEGORIES_TABLE+"."+CATEGORY_ID+" ORDER BY "+CATEGORIES_LANG_TABLE+"."+CATEGORY_TITLE+ " ASC";
			 String sql = "SELECT "+CATEGORIES_TABLE+"."+CATEGORY_COLOR+" AS "+CATEGORY_COLOR+" , "
				...
				" FROM "+CATEGORIES_TABLE+" LEFT JOIN "+CATEGORIES_LANG_TABLE
				+" ON ("+CATEGORIES_LANG_TABLE+"."+CATEGORY_ID+"="+CATEGORIES_TABLE+"."+CATEGORY_ID+" AND "+ CATEGORIES_LANG_TABLE+"."+CATEGORY_LOCALE+"= '"+locale.getLanguage()+"_"+locale.getCountry()+"') "
				+" WHERE "+CATEGORIES_TABLE+"."+CATEGORY_ID+" = "+id+" AND "+CATEGORIES_TABLE+"."+CATEGORY_TITLE+" IS NOT NULL AND "+CATEGORIES_LANG_TABLE+"."+CATEGORY_TITLE+" IS NULL"
